  ...
  return (
    <div className="min-h-screen bg-[#0d111a] text-gray-100 flex flex-col font-sans">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 max-w-[1600px] w-full mx-auto">
        ...
        {/* Left Side: Contracts Selection List (Takes 2 Columns) */}
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-3 overflow-y-auto max-h-[650px] pr-2">
            {loading ? (
              <div className="text-xs text-gray-500 py-10 text-center">Loading contracts from backend...</div>
        ...
        {/* Right Side: Selection Summary Column (Takes 1 Column) */}
        <div className="lg:col-span-1">
          <SelectionSummary 
            selectedContract={selectedContract} 
            onCancel={() => setSelectedContract(null)}
            onNext={() => alert(`Proceeding with Contract ID: ${selectedContract.ContractID}`)}
          />
        </div>
