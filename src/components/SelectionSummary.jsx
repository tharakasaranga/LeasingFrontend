...
export default function SelectionSummary({ selectedContract, onNext, onCancel }) {
    ...
    <div className="bg-[#171e30] rounded-xl border border-gray-800 p-5 flex flex-col h-full justify-between">
      <div className="space-y-6">
        ...
        {selectedContract ? (
          <div className="bg-[#121724] p-3 rounded-lg flex space-x-3 border border-gray-800">
            ...
            <div className="text-[11px] text-gray-300 grid grid-cols-2 gap-x-2 gap-y-0.5 w-full">
              <span className="text-gray-500">Contract No:</span> <span className="text-blue-400 text-right">HO/MB/505</span>
        ...
        <div className="space-y-3">
          <div className="bg-[#20293a] px-3 py-1.5 rounded-md text-xs font-medium text-gray-300">
            💰 Rebates
          </div>
      ...
      <div className="flex space-x-3 pt-6">
        ...
        <button 
          ...
          className="w-1/2 py-2.5 rounded-lg bg-blue-600 text-xs font-medium text-white hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-900/20"
        >
          Next
        </button>
      </div>
